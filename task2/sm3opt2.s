...
.L13:
	...
	# lw	a5,-40(s0)
    lw  a6, -40(s0)
	# .insn i 0x03, 2, a5, s0, -40
	# addi	a4,a5,1
    addi	a4,a6,1
	sw	a4,-40(s0)
	# .insn i 0x03, 5, a4, s0, -40

	# mv	a4,a5
	# lw	a5,-36(s0)
	lw  a3, -36(s0) # a3一直保留-36(s0)的值，可以省去下面的lw a5指令
	# add	a5,a5,a4
	add  a5, a3, a5
	# andi	a4,a3,0xff
	lw  a1, -24(s0) # a1一直保留-24(s0)
