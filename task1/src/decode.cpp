...
/* INSERT YOUR CODE FROM HERE */  
  else if(funct7 == 2)
    {
      ...
      else if (funct3 == 1) return instTable_.getEntry(InstId::rotleft);
      else if (funct3 == 2) return instTable_.getEntry(InstId::rotright);
      else if (funct3 == 3) return instTable_.getEntry(InstId::reverse); 
